...
import com.finanzas.sf.security.SfAccessDeniedHandler;
import com.finanzas.sf.security.SfAgreementAuthenticationEntryPoint;
...
public class AgreementSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationEntryPoint authenticationEntryPoint(){
        return new SfAgreementAuthenticationEntryPoint();
    }
    @Bean
    AccessDeniedHandler accessDeniedHandler(){
        return new SfAccessDeniedHandler();
    }
