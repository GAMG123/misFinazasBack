...
public interface IncomeService {
	...
	IncomeResponseDTO getIncome(Long idUser);
	void saveIncome(SaveIncomeRequestDTO guardarDatoRequestDTO);
	void deleteIncome(DeleteIncomeRequestDTO deleteIncomeRequestDTO);
